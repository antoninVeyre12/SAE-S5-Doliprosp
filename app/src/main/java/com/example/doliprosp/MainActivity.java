...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onResume() {
        ...
        // Charger les données pour les salons et prospects
        ...
        mesProspectViewModel.chargementProspect(); // Charger les prospects
        Log.d("laaaaa", mesProspectViewModel.getProspectListe().toString()); // Afficher la liste des prospects dans le log
    }
}